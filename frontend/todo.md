...
- [x] Profile shows “Logged in as: Parent” or “Logged in as: Staff”
- [x] Staff inbox link only when role is staff (dev: use OTP 654321)
...
- [ ] Profile screen
- [ ] **Wire students:** GET `/me/students` for linked students — currently MOCK_STUDENTS on profile
...
- [ ] Ticket list screen
- [ ] **Wire to real API:** GET `/tickets` (parent) — currently uses MOCK_TICKETS
- [ ] **Wire students:** GET `/me/students` for child filter — currently MOCK_STUDENTS
- [ ] Filter by:
  - [ ] Status
  - [ ] Child
...
- [ ] **Wire to real API:** GET `/tickets/{id}` — currently MOCK_TICKETS
- [ ] Ticket header:
  - [ ] Category
  - [ ] Status
  - [ ] Assigned role
...
- [ ] “Create Ticket” CTA
- [ ] **Wire to real API:** POST `/tickets` and GET `/me/students` for child list — currently mock submit and MOCK_STUDENTS
- [ ] **Wire guardrails:** Call API; show backend error messages for max open, cooldown, weekly cap
- [ ] Category selection
...
- [ ] **Wire to real API:** GET `/announcements`, POST `/announcements/{id}/read` — currently MOCK_ANNOUNCEMENTS
...
- [ ] **Wire to real API:** GET `/tickets` (staff) for inbox — currently MOCK_TICKETS
- [ ] Ticket inbox (assigned tickets only)
- [ ] Status filter
- [ ] Priority / urgency indicators
- [ ] Empty states
- [ ] E2E: Log in as staff (OTP 654321 in dev), open /staff, verify ticket list and detail

---

## ✅ 13. Staff Ticket Detail View

- [ ] **Wire to real API:** GET `/tickets/{id}`, POST `/tickets/{id}/reply`, PATCH status, internal notes — currently mock data
- [ ] Full ticket context
...
- [ ] Parent E2E: tickets list, create ticket, ticket detail, announcements, profile — **currently all use mock data; wire APIs first**
- [ ] Parent ticket creation (real POST /tickets + guardrail errors)
- [ ] Guardrail enforcement UX
- [ ] Staff E2E: login with 654321 → /staff inbox → ticket detail → reply/status/notes — **staff UI exists but uses MOCK_TICKETS; wire GET/POST/PATCH**
